...
const createUser = (user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isEmailExist) {
        throw new ApiError_1.default(http_status_1.default.CONFLICT, 'This email is already exist');
    }
    ...
    const token = jwtHelper_1.jwtHelpers.createToken({ email: result === null || result === void 0 ? void 0 : result.email }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    return { result, token };
});
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // create access token
    const token = jwtHelper_1.jwtHelpers.createToken({ email: userEmail }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    return {
        token,
    };
});
