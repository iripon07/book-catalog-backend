...
const createBook = (payload, userInfo) => __awaiter(void 0, void 0, void 0, function* () {
    const isUserExist = yield user_model_1.User.findOne({ email: userInfo === null || userInfo === void 0 ? void 0 : userInfo.email });
    if (!isUserExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, `User not exist`);
    }
    payload.createdBy = isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist._id;
    const result = (yield book_model_1.Book.create(payload)).populate('createdBy');
    if (!result) {
...
const getAllBooks = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { page, limit, skip, sortOrder, sortBy } = paginationHelper_1.paginationHelper.calculatePagination(paginationOptions);
    const andConditions = [];
    if (searchTerm) {
        andConditions.push({
...
const deleteBook = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const _id = payload;
    const result = yield book_model_1.Book.findByIdAndDelete(_id);
    return result;
});
const reviewBook = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield book_model_1.Book.findByIdAndUpdate({ _id: id }, { $push: { reviews: review } }, {
        new: true,
    });
    return result;
});
