...
const createBook = (payload, userInfo) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    payload.createdBy =
      isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist._id;
    const result = (yield book_model_1.Book.create(payload)).populate(
      'createdBy',
    );
    if (!result) {
      throw new ApiError_1.default(
